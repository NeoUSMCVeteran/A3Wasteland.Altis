...
private ["_transporteur", "_doLock", "_est_desactive", "_objets_charges"];
...
_transporteur addAction [("<img image='client\icons\save.paa' color='#ff0000'/> <t color='#06ef00'>Save Vehicle</t>"), "client\functions\savevehicle.sqf", _doLock, -5, false, true, "", "((_target distance _this) < 7)"];