...
_veh2 = ["O_APC_Tracked_02_AA_F","I_APC_tracked_03_cannon_F","O_APC_Tracked_02_cannon_F"] 	
call BIS_fnc_selectRandom ;
...
_marker setMarkerText "Hard armed Money Shipment (350k)";
...
_hint = parseText format ["<t align='center' color='%4' shadow='2' size='1.75'>Money Objective</t><br/><t align='center' color='%4'>------------------------------</t><br/><t align='center' color='%5' size='1.25'>%1</t><br/><t align='center'><img size='5' image='%2'/></t><br/><t align='center' color='%5'> <t color='%4'>%3</t> A very dangerous convoy composed by light and medium armoured vehicles carrying $350,000 is on route. Stop them! Be aware that the money is divided among both units!</t>", _missionType, _picture, _vehicleName, moneyMissionColor, subTextColor];
