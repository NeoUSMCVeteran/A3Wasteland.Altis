//	@file Version: 2
//	@file Name: mission_MoneyShipmentEasy.sqf
//	@file Author: JoSchaap / routes by Del1te - (original idea by Sanjo)
//  @file modified by: Argietaco for TOP3 servers
...
_veh2 = ["O_G_Offroad_01_armed_F","B_MRAP_01_gmg_F"] 	
call BIS_fnc_selectRandom ;

_veh3 = ["I_MRAP_03_hmg_F","I_MRAP_03_gmg_F"]								
call BIS_fnc_selectRandom ;
...
_marker setMarkerText "Easy armed Money Shipment";
...
_hint = parseText format ["<t align='center' color='%4' shadow='2' size='1.75'>Money Objective</t><br/><t align='center' color='%4'>------------------------------</t><br/><t align='center' color='%5' size='1.25'>%1</t><br/><t align='center'><img size='5' image='%2'/></t><br/><t align='center' color='%5'> <t color='%4'>%3</t> A convoy composed by light armed vehicles carrying $100,000 is on route. Stop them! Be aware that the money is divided among both units!</t>", _missionType, _picture, _vehicleName, moneyMissionColor, subTextColor];
