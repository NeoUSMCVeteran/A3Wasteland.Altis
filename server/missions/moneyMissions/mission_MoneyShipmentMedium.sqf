//	@file Version: 2
//	@file Name: mission_MoneyShipmentMedium.sqf
//	@file Author: JoSchaap / routes by Del1te - (original idea by Sanjo)
//  @file contributors: Argietaco for TOP3 Wasteland
...
_veh1 = ["O_MRAP_02_hmg_F","O_G_Offroad_01_armed_F"]
call BIS_fnc_selectRandom ;

_veh2 = ["I_APC_tracked_03_cannon_F","O_APC_Tracked_02_cannon_F"] 	
call BIS_fnc_selectRandom ;
...
_marker setMarkerText "Medium armed Money Shipment";
...
_hint = parseText format ["<t align='center' color='%4' shadow='2' size='1.75'>Money Objective</t><br/><t align='center' color='%4'>------------------------------</t><br/><t align='center' color='%5' size='1.25'>%1</t><br/><t align='center'><img size='5' image='%2'/></t><br/><t align='center' color='%5'> <t color='%4'>%3</t> A dangerous convoy composed by light and medium armoured vehicles carrying $200,000 is on route. Stop them! Be aware that the money is divided among both units!</t>", _missionType, _picture, _vehicleName, moneyMissionColor, subTextColor];
