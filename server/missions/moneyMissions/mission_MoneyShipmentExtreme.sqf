//	@file Version: 2
//	@file Name: mission_MoneyShipmentExtreme.sqf
...
private ["_missionMarkerName","_missionType","_picture","_vehicleName","_hint","_waypoint","_routes","_MoneyShipmentVeh","_veh1","_veh2","_veh3","_rn","_waypoints","_starts","_startdirs","_group","_vehicles","_marker","_failed","_startTime","_numWaypoints","_cash1","_cash2","_createVehicle","_leader"];
...
_veh1 = ["B_APC_Tracked_01_rcws_F","B_APC_Tracked_01_CRV_F","B_APC_Wheeled_01_cannon_F","O_APC_Tracked_02_AA_F"]
call BIS_fnc_selectRandom ;

_veh2 = ["B_MBT_01_TUSK_F","O_APC_Tracked_02_AA_F","O_MBT_02_cannon_F","I_MBT_03_cannon_F"] 	
call BIS_fnc_selectRandom ;

_veh3 = ["I_MRAP_03_hmg_F","I_MRAP_03_gmg_F","I_APC_Wheeled_03_cannon_F"]								
call BIS_fnc_selectRandom ;
...
_vehicles set [1, [_veh2, (_starts select 0), (_startdirs select 0), _group] call _createVehicle];
_vehicles set [2, [_veh3, (_starts select 0), (_startdirs select 0), _group] call _createVehicle];
...
_marker setMarkerText "Extreme armed Money Shipment (500k)";
...
_hint = parseText format ["<t align='center' color='%4' shadow='2' size='1.75'>Money Objective</t><br/><t align='center' color='%4'>------------------------------</t><br/><t align='center' color='%5' size='1.25'>%1</t><br/><t align='center'><img size='5' image='%2'/></t><br/><t align='center' color='%5'> <t color='%4'>%3</t> An extreme dangerous convoy composed by light, medium and heavy armoured vehicles carrying $500,000 is on route. Stop them! Be aware that the money is divided among both units!</t>", _missionType, _picture, _vehicleName, moneyMissionColor, subTextColor];
